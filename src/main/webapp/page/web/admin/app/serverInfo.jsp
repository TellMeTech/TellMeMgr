	...
	<div class="con-right" id="conRight">
		<div class="fl yw-lump">
			<div class="yw-lump-title">
				<i id="i_back" class="yw-icon icon-back" onclick="javascript:history.back();"></i><span>服务指南：${u.id == 0 ? "新建服务指南":u.name }</span>
			</div>
		</div>
		...
		<div class="fl yw-lump mt10">
			<div class="yw-bi-rows">
				<div class="yw-bi-tabs mt5" id="ywTabs">
					<span class="yw-bi-now">服务指南详情</span>
				</div>
				<div class="fr"> 
			...
			<div id="tab1" class="yw-tab">
				<form id="roleForm" name="roleForm"
					...
					<table class="yw-cm-table font16">
						<tr>
							<td width="10%" align="center">服务指南标题：</td>
							<td>
						...
						<tr>
							<td width="10%" align="center">服务指南图片：</td>
							<td>
								<input name="name" accept="image/png,image/jpeg" type="file" style="width:254px;height:28px;" /> 
								<span style="color:red">*</span>
							</td>
						</tr>
						<tr>
							<td align="center">服务指南描述：</td>
