	...
	<div class="con-right" id="conRight">
		<div class="fl yw-lump">
			<div class="yw-lump-title">
				<i class="yw-icon icon-partner"></i><span>发现列表</span>  
			</div>
		</div> 
           ...
           <form  id="UserForm" name="UserForm" action="userList.do" method="get">
           	<div class="pd10-28">
                   <div class="fr">
                   	...
                   	<span class="yw-btn bg-green ml20 cur" onclick="window.location.href='discoveryInfo.do?id=0'">新建模块</span> 
                   </div>
                   <div class="cl"></div>
               </div>
