	...
	<div class="con-right" id="conRight">
		<div class="fl yw-lump">
			<div class="yw-lump-title">
				<i class="yw-icon icon-partner"></i><span>反馈列表</span>  
			</div>
		</div> 
           ...
           <form  id="UserForm" name="UserForm" action="userList.do" method="get">
           	<div class="pd10-28">
                   <div class="fr">
                   	...
                   	<span class="yw-btn bg-green ml20 cur" onclick="">回复</span> 
                   </div>
                   <div class="cl"></div>
               </div>
	           	...
	           	<table class="yw-cm-table yw-leftSide yw-bg-hover"  id="userList">
	                ...
	                <c:forEach var="item"  items="${users}">
	              		<tr>
			            	...
			            	<td align="left" ><span style="margin-left:40px">qq1025546231</span></td>
			            	<td align="left" >假如这就是反馈的内容</td>
			            	<td align="left" >已回复</td>
			            	<td>
			            		<a href="javascript:void(0);" onclick="window.location.href='userInfo.do?id=${item.id}'" style="padding-left:5px;margin-top:25px" >回复</a>
			            	</td>
			            </tr>
	                </c:forEach>
	               </table>
