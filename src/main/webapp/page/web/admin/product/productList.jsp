	...
	<div class="con-right" id="conRight">
		<div class="fl yw-lump">
			<div class="yw-lump-title">
				<i class="yw-icon icon-partner"></i><span>商品列表</span>  
			</div>
		</div> 
           ...
           <form  id="UserForm" name="UserForm" action="userList.do" method="get">
           	<div class="pd10-28">
                   <div class="fr">
                   	...
                   	<span class="yw-btn bg-green ml20 cur" onclick="">新建商品</span> 
                   </div>
                   <div class="cl"></div>
               </div>
	           	...
	           	<table class="yw-cm-table yw-leftSide yw-bg-hover"  id="userList">
	                ...
	                <c:forEach var="item"  items="${users}">
	              		<tr>
			            	...
			            	<td align="left" ><span style="margin-left:40px">防晒霜</span></td>
			            	<td align="left" >生活用品</td>
			            	<td align="left" >128</td>
			            	<td align="left" >上架</td>
			            	<td>
			            		<a href="javascript:void(0);" onclick="window.location.href='userInfo.do?id=${item.id}'" style="padding-left:5px;margin-top:25px" >参数详情</a>
