	...
	<div class="con-right" id="conRight">
		<div class="fl yw-lump">
			<div class="yw-lump-title">
				<i class="yw-icon icon-partner"></i><span>商品规格列表</span>  
			</div>
		</div> 
           ...
           <form  id="UserForm" name="UserForm" action="userList.do" method="get">
           	<div class="pd10-28">
                   <div class="fr">
                   	...
                   	<span class="yw-btn bg-green ml20 cur" onclick="">新建商品规格</span> 
                   </div>
                   <div class="cl"></div>
               </div>
	           	...
	           	<table class="yw-cm-table yw-leftSide yw-bg-hover"  id="userList">
	                ...
	                <c:forEach var="item"  items="${users}">
	              		<tr>
			            	...
			            	<td align="left" ><span style="margin-left:40px">容量</span></td>
			            	<td align="left" >150ml</td>
			            	<td>
