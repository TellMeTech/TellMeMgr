	...
	<div class="con-right" id="conRight">
		<div class="fl yw-lump">
			<div class="yw-lump-title">
				<i class="yw-icon icon-partner"></i><span>分类列表</span>  
			</div>
		</div> 
           ...
           <form  id="UserForm" name="UserForm" action="userList.do" method="get">
           	<div class="pd10-28">
                   <div class="fr">
                   	...
                   	<span class="yw-btn bg-green ml20 cur" onclick="">新建分类</span> 
                   </div>
                   <div class="cl"></div>
               </div>
	           	...
	           	<table class="yw-cm-table yw-leftSide yw-bg-hover"  id="userList">
	                ...
	                <c:forEach var="item"  items="${users}">
	              		<tr>
			            	...
			            	<td align="left" ><span style="margin-left:40px">生活用品</span></td>
