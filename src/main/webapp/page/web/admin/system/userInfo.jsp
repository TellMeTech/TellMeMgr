...
<script type="text/javascript"> 
	...
	$(document).ready(function(){
		...
		function loadRoleInfo(){
			$.ajax({
				url : "jsonLoadRoleList.do",
				type : "post",  
				dataType:"json",  
				success : function(data) { 
		  			if(data.code == 0){ 
						$("#role_combo").combobox("loadData",data.list);
						$("#role_combo").combobox("setValue",data.list[0].id);
		  			}else{
				...
				<form id="roleForm" name="roleForm"
					...
					<table class="yw-cm-table font16">
						...
						<tr>
							...
							<td><input id="role_combo" class="easyui-combobox" data-options="valueField:'id',textField:'name'" style="width:254px;height:28px;" />
							<span style="color:red">*</span>
							</td>
						</tr>   
					</table>
