...
<body class="login">
            ...
            <div class="fl login-left">
                ...
                <div class="fl panel">
                	<p class="login-rows mt30">
                    	<input type="text" name="name" id="loginName" class="login-input login-name easyui-validatebox" placeholder="用户名"  validType="Length[4,22]" data-options="required:true" value="<shiro:principal/>" onblur="GetPwdAndChk();"/>
                    </p>
                    <p class="login-rows mt30">
    ...
    <div class="bottom">
    	<p>&copy;优创引力研发 2016. ALL rights reserved.</p>
    </div>
</body>
</html>